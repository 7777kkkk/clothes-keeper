...
- **设置页面按钮功能最终修复（SettingsScreen）**
  - 删除「给 App 评分」按钮（已有完整功能后不再需要占位提示）
  - 删除「分享给好友」按钮（功能完整后移除占位提示）
  - 「关于衣橱」Alert 信息更新：App 名称→衣服管家、版本→1.0.0、开发日期→2026-04、简介→帮您管理衣橱，记录穿搭
  - 新增「联系我们」按钮，点击显示邮箱：zhh102477@outlook.com、473893506@qq.com
  - 通用设置 4 个按钮（外观模式/衣橱季节/身材数据/货币单位）已有完整功能，验证确认无占位提示
